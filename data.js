...
export const EXTRA_VIEWS =[
  ...
  { id: "magnetar", label: "Magnetar" },       
  { id: "binary", label: "Bintang Ganda" },    
  { id: "uyscuti", label: "UY Scuti" },        
...
export const SOLAR_DATA = {
  ...
  "Europa": { viewId: "solar", radius: 4, distance: 355, speed: 3.5, color: "#fef08a", info: { Kategori: "Satelit Jupiter", Suhu: "-160°C", Karakteristik: "Lautan Bawah Es" }, desc: "Bulan milik Jupiter yang diyakini menyimpan lautan air cair luas di bawah lapisan esnya.", layers:["Inti Berbatu", "Lautan Cair", "Kerak Es Tebal"] },
  ...
  "Titan": { viewId: "solar", radius: 5, distance: 465, speed: 2.0, color: "#fb923c", info: { Kategori: "Satelit Saturnus", Suhu: "-179°C", Atmosfer: "Nitrogen Tebal" }, desc: "Bulan Saturnus, satu-satunya satelit dengan atmosfer tebal dan danau metana cair.", layers:["Inti Silikat", "Lautan Air Bawah Tanah", "Kerak Es", "Atmosfer Tebal"] },
...
export const DEEP_SPACE_DATA = {
  ...
  "Magnetar": { viewId: "magnetar", color: "#e879f9", info: { Kategori: "Bintang Neutron", Magnet: "1.000 Triliun Gauss" }, desc: "Benda dengan medan magnet terkuat di alam semesta, mampu menghancurkan atom dari jarak ribuan kilometer.", layers: ["Medan Magnet Ekstrem", "Kerak Neutron", "Plasma Cair"] },
  "Bintang Ganda": { viewId: "binary", color: "#818cf8", info: { Kategori: "Sistem Biner (Sirius)", Jarak: "8.6 Tahun Cahaya" }, desc: "Dua bintang yang saling mengorbit; bintang terang kebiruan raksasa dan katai putih padat.", layers:["Bintang Utama (Sirius A)", "Katai Putih (Sirius B)", "Pusat Massa Gravitasi"] },
  "UY Scuti": { viewId: "uyscuti", color: "#fca5a5", info: { Kategori: "Maha Raksasa Merah", Radius: "1.700x Matahari" }, desc: "Salah satu bintang terbesar yang pernah ditemukan. Jika diletakkan di Tata Surya, ukurannya menelan planet Jupiter.", layers:["Fotosfer Bergolak", "Lidah Api Raksasa (Flares)", "Inti Fusi Karbon"] },
  "Exoplanet": { viewId: "exoplanet", color: "#14b8a6", info: { Kategori: "Planet Ekstrasurya", Bintang Induk: "Kepler-186", Status: "Habitable Zone" }, desc: "Planet kembaran bumi di tata surya lain yang diyakini memiliki danau dan lautan beriklim stabil.", layers:["Atmosfer Asing", "Lautan Cair Asing", "Benua Bebatuan", "Inti Magma"] }
};
